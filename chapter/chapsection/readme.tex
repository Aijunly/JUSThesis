...
\begin{jllisting}[language={C}, caption={一段C源代码}, label=code:1]
#include <stdio.h>
...
\begin{table}[!htp]
	\centering
		\bicaption{中文表格名}
	{English names}\label{tab:typename}
	\begin{tabular}{c|c|c|c}
		\hline
		缩写 & 全称 & 缩写 & 全称 \\
		 \hline % \specialrule{0.5pt}{0pt}{0pt}  % 自定义粗线
...
为了让文章可读性更强，我们通常会在\verb|\ref|命令前加入类型名，

如\verb|<定理\ref{thm:telescope}>|。
