...
\newcommand\thesisTitleCN{城市空气质量监测系统的设计与实现}   		% 中文题目
\newcommand\thesisTitleEN{Design and Implementation of Urban Air Quality Monitoring System}   		% 英文题目
...
\newcommand\thesisDate{2026 年 6 月}    % 提交日期
...
%    {
        ...
        \zihao{-3} %\bfseries 
        \makebox[5cm][c]{\songti \thesisDate}\par
		\end{center}
%    }
}
%{   
